...
export function AppSidebar({ collapsible = false, onNavigate }: { collapsible?: boolean; onNavigate?: () => void }) {
  ...
  return <aside aria-label="Navegação principal" className={cn("flex h-full flex-col border-r border-[var(--border)] bg-[var(--surface)] px-3 py-4 transition-[width] duration-200 ease-out", collapsed && collapsible ? "w-[72px]" : "w-[260px]")}>
